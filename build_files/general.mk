...
.PHONY: error_message
error_message:
	$(error ERROR: You must specify PROGRAM_MK or LIBRARY_MK in the makefile)
endif

ifeq ($(DL_COMPORT), )
.PHONY: error_message2
error_message2:
	$(error ERROR: You must specify DL_COMPORT in the makefile)
endif

ifeq ($(DL_BAUDRATE), )
.PHONY: error_message3
error_message3:
	$(error ERROR: You must specify DL_BAUDRATE in the makefile)
endif

ifeq ($(DL_CRYSTAL), )
.PHONY: error_message4
error_message4:
	$(error ERROR: You must specify DL_CRYSTAL in the makefile)
endif
...
ifeq ($(CPU_VARIANT),LPC2364)
  ifndef LD_SCRIPT
    ifndef LD_RAMROM
LD_SCRIPT = ../build_files/link_8k_128k_rom.ld
    else
      ifeq ($(LD_RAMROM),ROM)
LD_SCRIPT = ../build_files/link_8k_128k_rom.ld
      else
LD_SCRIPT = ../build_files/link_8k_128k_ram.ld
      endif
    endif
  endif
else

ifeq ($(CPU_VARIANT),LPC2366)
  ifndef LD_SCRIPT
    ifndef LD_RAMROM
LD_SCRIPT = ../build_files/link_32k_256k_rom.ld
    else
...
ifeq ($(CPU_VARIANT),LPC2388)
  ifndef LD_SCRIPT
    ifndef LD_RAMROM
LD_SCRIPT = ../build_files/link_64k_512k_rom.ld
    else
      ifeq ($(LD_RAMROM),ROM)
LD_SCRIPT = ../build_files/link_64k_512k_rom.ld
      else
LD_SCRIPT = ../build_files/link_64k_512k_ram.ld
      endif
    endif
  endif
else

ifeq ($(CPU_VARIANT),LPC2468)
  ifndef LD_SCRIPT
    ifndef LD_RAMROM
LD_SCRIPT = ../build_files/link_64k_512k_rom.ld
    else

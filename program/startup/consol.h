 ...
 *****************************************************************************/
#if CONSOL_UART == 0
#define UART_RBR U0RBR     //RO - Receiver Buffer
#define UART_THR U0THR     //WO - Transmit Holding
#define UART_IER U0IER     //RW - Interrupt Enable
#define UART_IIR U0IIR     //RO - Interrupt ID
#define UART_FCR U0FCR     //WO - FIFO Control
#define UART_LCR U0LCR     //RW - Line Control
#define UART_LSR U0LSR     //RO - Line Status
#define UART_SCR U0SCR     //RW - Scratch Pad
#define UART_DLL U0DLL     //RW - Divisor Latch LSB (DLAB = 1)
#define UART_DLM U0DLM     //RW - Divisor Latch MSB (DLAB = 1)
#else
